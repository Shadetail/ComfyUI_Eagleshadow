...
class LoadDiffusionModelWithName:
    """
    Fork of the core "Load Diffusion Model" (UNETLoader) node that also outputs
    the model file name (without the .safetensors extension and without any
    subfolder path) as a STRING, handy for building output filenames.
    """
    @classmethod
    def INPUT_TYPES(cls):
    ...
    def load_unet(self, unet_name, weight_dtype):
        ...
        # Strip any subfolder path and the file extension for a clean name.
...
NODE_CLASS_MAPPINGS = {
    ...
    "Load Diffusion Model With Name": LoadDiffusionModelWithName,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "Load Diffusion Model With Name": "Load Diffusion Model With Name"
}
